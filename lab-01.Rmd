...
_How many regions have more than 50 tourist attraction in the data set? (Hint: You will need to tabulate the data before filtering.)

```{r Ex_g}
#visitors %>% 
#  tabulate(region) %>% #counts how many times each region appears
#  filter(n_2022 > 5)
```
...
**Not Applicable - Because there are missing data values that cannot be taken into consideration in the average**
...
**"na.rm = TRUE" ignores NAs in the calculation**
...
**There are high-end outliers in the dataset**
